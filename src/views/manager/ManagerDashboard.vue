<template>
  <div class="page-container role-dashboard">
    <div class="role-banner manager-banner">
      <div class="banner-content">
        <h1 class="banner-title">您好，{{ userStore.user?.name }}</h1>
        <p class="banner-subtitle">健康管家工作台</p>
      </div>
    </div>
    ...
    <div class="stats-row">
      <div class="stat-card">
        ...
        <span class="stat-label">管理会员</span>
      </div>
...
.manager-banner {
  background: linear-gradient(135deg, #2E8B57 0%, #3DA06A 100%);
}
