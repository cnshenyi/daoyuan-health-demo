...
const conversations = [
  { id: 1, name: '沈轶' }, { id: 2, name: '吴大伟' }, { id: 3, name: '林雅婷（管家）' },
  { id: 4, name: '赵晓雯' }, { id: 5, name: '王芳' }, { id: 6, name: '张慧敏' }, { id: 7, name: '李明华医生' },
]
const conv = conversations.find(c => c.id === convId) || conversations[0]

const messages = ref([
  { id: 1, from: 'other', text: '陈老师您好，今天的饮食记录已经上传了', time: '09:30' },
  { id: 2, from: 'me', text: '收到！我看了一下，今天碳水摄入控制得不错，继续保持。晚餐可以多加一些深色蔬菜。', time: '09:45' },
  { id: 3, from: 'other', text: '好的，那运动方面今天需要做什么？', time: '09:50' },
  { id: 4, from: 'me', text: '今天安排30分钟快走，心率控制在120-140之间。运动后记得补充水分。', time: '09:52' },
  { id: 5, from: 'other', text: '明白了，谢谢陈老师', time: '09:53' },
])

const inputText = ref('')
const chatBody = ref<HTMLElement | null>(null)
const quickReplies = ['饮食记录已查看', '运动方案已更新', '请按时记录', '数据很好，继续保持']
...
.msg-avatar { width: 30px; height: 30px; border-radius: 50%; background: linear-gradient(135deg,#E67E22,#F39C12); color: #fff; font-size: 11px; font-weight: 700; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
...
.bubble-me .msg-text { background: #E67E22; color: #fff; border-radius: 12px 4px 12px 12px; }
...
.quick-tag { white-space: nowrap; font-size: 12px; padding: 4px 10px; background: rgba(230,126,34,0.08); color: #E67E22; border-radius: 12px; cursor: pointer; flex-shrink: 0; }
...
.chat-input:focus { border-color: #E67E22; background: #fff; }
.send-btn { width: 56px; height: 36px; background: #E67E22; color: #fff; border: none; border-radius: 18px; font-size: 13px; font-weight: 600; cursor: pointer; flex-shrink: 0; }
</style>
