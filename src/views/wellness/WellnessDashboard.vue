<template>
  <div class="page-container role-dashboard">
    <div class="role-banner wellness-banner">
      <div class="banner-content">
        <h1 class="banner-title">您好，{{ userStore.user?.name }}</h1>
        <p class="banner-subtitle">营养与康复工作台</p>
      </div>
    </div>
    ...
    <div class="stats-row">
      ...
      <div class="stat-card">
        ...
        <span class="stat-label">待更新方案</span>
      </div>
      <div class="stat-card">
        <span class="stat-num">7</span>
        <span class="stat-label">本周跟进</span>
      </div>
    </div>
      ...
      >
        ...
        <div class="member-info">
          ...
          <div class="progress-bar">
            <div class="progress-fill" :style="{ width: m.healthScore + '%' }"></div>
          </div>
        </div>
...
.progress-fill { height: 100%; background: linear-gradient(90deg, #E67E22, #F39C12); border-radius: 2px; transition: width 0.3s; }
